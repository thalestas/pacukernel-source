...
static int ts050_init_sequence(struct mipi_dsi_device *dsi) {
	mipi_dsi_dcs_write_seq(dsi, 0xB9, 0xFF, 0x83, 0x99);
	mipi_dsi_dcs_write_seq(dsi, 0xBA, 0x63, 0x23, 0x68, 0xCF);
	mipi_dsi_dcs_write_seq(dsi, 0xD2, 0x55);
	mipi_dsi_dcs_write_seq(dsi, 0xB1, 0x02, 0x04, 0x70, 0x90, 0x01, 0x32, 0x33, 0x11, 0x11, 0x4D, 0x57, 0x56, 0x73, 0x02, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xB2, 0x00, 0x80, 0x80, 0xAE, 0x0A, 0x0E, 0x75, 0x11, 0x00, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xB4, 0x00, 0xFF, 0x04, 0xA4, 0x02, 0xA0, 0x00, 0x00, 0x10, 0x00, 0x00, 0x02, 0x00, 0x24, 0x02, 0x04, 0x0A, 0x21, 0x03, 0x00, 0x00, 0x08, 0xA6, 0x88, 0x04, 0xA4, 0x02, 0xA0, 0x00, 0x00, 0x10, 0x00, 0x00, 0x02, 0x00, 0x24, 0x02, 0x04, 0x0A, 0x00, 0x00, 0x08, 0xA6, 0x00, 0x08, 0x11);
	mipi_dsi_dcs_write_seq(dsi, 0xD3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x18, 0x32, 0x10, 0x09, 0x00, 0x09, 0x32, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x02, 0x02, 0x03, 0x00, 0x00, 0x00, 0x0A, 0x40);
	mipi_dsi_dcs_write_seq(dsi, 0xD5, 0x18, 0x18, 0x18, 0x18, 0x21, 0x20, 0x18, 0x18, 0x19, 0x19, 0x19, 0x19, 0x18, 0x18, 0x18, 0x18, 0x03, 0x02, 0x01, 0x00, 0x2F, 0x2F, 0x30, 0x30, 0x31, 0x31, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18);
	mipi_dsi_dcs_write_seq(dsi, 0xD6, 0x18, 0x18, 0x18, 0x18, 0x20, 0x21, 0x19, 0x19, 0x18, 0x18, 0x19, 0x19, 0x18, 0x18, 0x18, 0x18, 0x00, 0x01, 0x02, 0x03, 0x2F, 0x2F, 0x30, 0x30, 0x31, 0x31, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18);
	mipi_dsi_dcs_write_seq(dsi, 0xD8, 0x0A, 0xBE, 0xFA, 0xA0, 0x0A, 0xBE, 0xFA, 0xA0);
	mipi_dsi_dcs_write_seq(dsi, 0xBD, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xD8, 0x0F, 0xFF, 0xFF, 0xE0, 0x0F, 0xFF, 0xFF, 0xE0);
	mipi_dsi_dcs_write_seq(dsi, 0xBD, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xD8, 0x0F, 0xFF, 0xFF, 0xE0, 0x0F, 0xFF, 0xFF, 0xE0);
	mipi_dsi_dcs_write_seq(dsi, 0xBD, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xE0, 0x01, 0x35, 0x41, 0x3B, 0x79, 0x81, 0x8C, 0x85, 0x8E, 0x95, 0x9B, 0xA0, 0xA4, 0xAB, 0xB1, 0xB3, 0xB7, 0xC5, 0xBD, 0xC5, 0xB6, 0xC2, 0xC2, 0x62, 0x5D, 0x66, 0x73, 0x01, 0x35, 0x41, 0x3B, 0x79, 0x81, 0x8C, 0x85, 0x8E, 0x95, 0x9B, 0xA0, 0xA4, 0xAB, 0xB1, 0xB3, 0xB7, 0xB5, 0xBD, 0xC5, 0xB6, 0xC2, 0xC2, 0x62, 0x5D, 0x66, 0x73);
	mipi_dsi_dcs_write_seq(dsi, 0xB6, 0x97, 0x97);
	mipi_dsi_dcs_write_seq(dsi, 0xCC, 0xC8);
	mipi_dsi_dcs_write_seq(dsi, 0xBF, 0x40, 0x41, 0x50, 0x19);
	mipi_dsi_dcs_write_seq(dsi, 0xC6, 0xFF, 0xF9);
	mipi_dsi_dcs_write_seq(dsi, 0xC0, 0x25, 0x5A);
...
static int khadas_ts050_panel_prepare(struct drm_panel *panel)
{
	...
	ts050_init_sequence(khadas_ts050->link);
